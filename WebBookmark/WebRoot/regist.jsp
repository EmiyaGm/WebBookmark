...
<html>
  ...
  <script type="text/javascript">
	  ...
	  //验证密码 
		function checkpsd1(){
           ...
           //验证确认密码
           function checkpsd2(){
               if(form1.password.value!=form1.cp.value){
		...
		function checkmail(){
					apos=form1.em.value.indexOf("@");
					dotpos=form1.em.value.lastIndexOf(".");
  ...
  <body>
    <div class="contact" >
      <form action="/WebBookmark/regist.do" method="post" name="form1">
        <ul>
          <li>
            <label>姓名：</label><input type="text" name="username" placeholder="请输入用户名"  onblur="checkna()" required/><span class="tips" id="divname">长度1~12个字符</span>
          </li>
          <li>
          ...
          <li>
            <label>确认密码：</label><input type="password" name="cp" placeholder="请再次输入你的密码" onBlur="checkpsd2()" required/><span class="tips" id="divpassword2">两次密码需要相同</span>
          </li>
          <li>
            <label>电子邮箱：</label><input type="text" name="em" placeholder="请输入你的邮箱" onBlur="checkmail()" required/><span class="tips" id="divmail"></span>
          </li>
        </ul>
        <b class="btn">
